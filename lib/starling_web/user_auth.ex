defmodule StarlingWeb.UserAuth do
  use StarlingWeb, :verified_routes

  import Plug.Conn
  import Phoenix.Controller

  alias Starling.Accounts
  alias Starling.Accounts.Scope

  # Make the remember me cookie valid for 14 days. This should match
  # the session validity setting in UserToken.
  @max_cookie_age_in_days 14
  @remember_me_cookie "_starling_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      StarlingWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def require_admin(conn, _opts) do
    if conn.assigns.current_scope && conn.assigns.current_scope.user && conn.assigns.current_scope.user.admin do
      conn
    else
      conn
