defmodule StarlingWeb.PostControllerTest do
  use StarlingWeb.ConnCase

  import Starling.PostsFixtures

  @create_attrs %{description: "some description", title: "some title", body: "some body", slug: "some slug", published_at: ~D[2025-10-27], draft: true}
